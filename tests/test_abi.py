...
def test_coder():
    assert (
        abi.Coder.encode_single("uint256", 2345675643).hex()
...
def test_abiv2():
        ...
        "list": [
            {
                ...
                "identity": b"I\x98JS\xf99sp\x07\x9b\xba\x8d\x95\xf5\xc1\\t0\x98\xfb1\x84\x83\xe0\xcbk\xbfF\xec\x89\xcc\xfb",
                "active": False,
            },
            {
                "master": "0x5ff66ee3a3ea2aba2857ea8276edb6190d9a1661",
                "endorsor": "0xd51666c6b4fed6070a78691f1f3c8e79ad02e3a0",
                "identity": b"v\xf0\x90\xd3\x83\xf4\x9d\x8f\xaa\xb2\xeb\x15\x12AR\x8aU/\n\xe6E\xf4`6\nv5\xb8\x889\x87\xa6",
                "active": False,
            },
            {
                "master": "0xc5a02c1eac7516a9275d86c1cb39a5262b8684a4",
                "endorsor": "0xe32499b4143830f2526c79d388ecee530b6357aa",
                "identity": b"\xc65\x89JP\xce\\t\xc6-#\x8d\xbe\x95\xbdj\x0f\xa0v\x02\x9d\x91=v\xb0\xd0\xb1\x11\xc58\x15?",
                "active": False,
            },
            {
                "master": "0x0e8fd586e022f825a109848832d7e552132bc332",
                "endorsor": "0x224626926a7a12225a60e127cec119c939db4a5c",
                "identity": b"\xdb\xf2q.\x19\xaf\x00\xdcM7g(\xf7\xcb\x06\xcc!\\\x8e|S\xb9L\xb4|\xef\xb4\xa2j\xda*l",
                "active": False,
            },
            {
                "master": "0xea2e8c9d6dcad9e4be4f1c88a3befb8ea742832e",
                "endorsor": "0x1a011475baa1d368fa2d8328a1b7a8d848b62c94",
                "identity": b"\xc6\x8d\xc8\x11\x19\x9d@\xff~\xcd\x8c\x8dFEJ\xd9\xac_\\\xde\x9b\xae2\xf9'\xfe\xc1\r\x82\xdb\xdfx",
                "active": False,
            },
            {
                "master": "0x4977d68df97bb313b23238520580d8d3a59939bf",
                "endorsor": "0x7ad1d568b3fe5bad3fc264aca70bc7bcd5e4a6ff",
                "identity": b"\x83\xb17\xcf~0\x86K\x8aNVE>\xb1\xf0\x94\xb4CF\x85\xd8h\x95\xde8\xac.\xdc\xf5\xd3\xf54",
                "active": False,
            },
        ]
    }
    ...
    for expected, actual in zip_longest(data["list"], decoded.list):
        assert expected == actual._asdict()
